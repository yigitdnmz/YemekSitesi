...
namespace YemekSitesi
{
    public partial class TarifOner : System.Web.UI.Page
    {
        ...
        {
            //Tarif oner sayfasinda tarif oner butonuna basildiginda sql veri tabanindan cekmesi gereken veriler yaziyor.
            ...
            komut.ExecuteNonQuery(); // burada yazilan datayi sql'e gonderiyor.
            bgl.baglanti().Close();  // gonderilmis durumu bitiriyor.
